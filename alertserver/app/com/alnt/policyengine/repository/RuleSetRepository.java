...
@Singleton
public class RuleSetRepository extends BaseRepositoryImpl<RuleSet> implements BaseRepository<RuleSet> {

	@Inject
	public RuleSetRepository(JPAApi jpaApi, DatabaseExecutionContext executionContext) {
		super(jpaApi, executionContext, RuleSet.class);
	}
